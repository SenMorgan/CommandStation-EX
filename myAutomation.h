...
ALIAS(CARGO_RESET_FUNCTIONS)
SEQUENCE(CARGO_RESET_FUNCTIONS)
  XFOFF(CARGO, CARGO_LIGHTS_F)
  XFOFF(CARGO, CARGO_POWER_SOUND_F)
  XFOFF(CARGO, CARGO_ENGINE_MODE_F)
  XFOFF(CARGO, CARGO_DETONATORS_F)
  XFOFF(CARGO, CARGO_CAB_START_UP_F)
  XFOFF(CARGO, CARGO_DOORS_F)
  XFOFF(CARGO, CARGO_AIR_CONDITIONING_F)
  XFOFF(CARGO, CARGO_WIPERS_F)
  XFOFF(CARGO, CARGO_FLANGE_SQUEAL_F)
  XFOFF(CARGO, CARGO_STATION_SOUND_F)
  XFOFF(CARGO, CARGO_INSPECTION_LIGHTS_F)
  XFOFF(CARGO, CARGO_CABIN_LIGHT_F)
  XFOFF(CARGO, CARGO_SHUNTING_MODE_F)
  XFOFF(CARGO, CARGO_AFC_ENABLE_F)
  XFON(CARGO, CARGO_RAIL_CLACK_F)   // Enable rail clack
  RETURN
...
ALIAS(CARGO_START)
SEQUENCE(CARGO_START)
  // Train driver comes in
  FON(CARGO_CAB_START_UP_F)
  DELAY(2000)
  FON(CARGO_INSPECTION_LIGHTS_F)
  DELAY(1000)
  FON(CARGO_AFC_ENABLE_F)
  DELAY(10000)
  FOFF(CARGO_INSPECTION_LIGHTS_F)
  DELAY(2000)
  RETURN
...
ALIAS(SBB_CARGO_FULL_STOP)
SEQUENCE(SBB_CARGO_FULL_STOP)
  FON(CARGO_INSPECTION_LIGHTS_F)
  DELAY(5000)
  FOFF(CARGO_AFC_ENABLE_F)
  FOFF(CARGO_LIGHTS_F)
  DELAY(5000)
  FOFF(CARGO_INSPECTION_LIGHTS_F)
  DELAY(1000)
  FOFF(CARGO_CAB_START_UP_F)
  RETURN
...
ALIAS(CARGO_SET_FORWARD_DIRECTION)
SEQUENCE(CARGO_SET_FORWARD_DIRECTION)
  FWD(0)
  DELAY(2000)
  RETURN
...
ALIAS(CARGO_SET_REVERSE_DIRECTION)
SEQUENCE(CARGO_SET_REVERSE_DIRECTION)
  REV(0)
  DELAY(2000)
  RETURN
...
AUTOMATION(300,"Route 300")
  CALL(VOSSLOH_RESET_FUNCTIONS)
  CALL(CARGO_RESET_FUNCTIONS)
  SET_TRACK(A, MAIN)
  SET_TRACK(B, MAIN)
  POWERON
  DELAY(3000)
  ...
  CALL(THROW_TURNOUTS)
  // Change lights direction
  CALL(CARGO_SET_REVERSE_DIRECTION)
  REV(28)

  ATTIMEOUT(R_EDGE, 25000)
  STOP
  DELAY(10000)
  // Change lights direction
  CALL(CARGO_SET_FORWARD_DIRECTION)
  // Go back to the left
  FWD(42)
  ATTIMEOUT(L_WALL, 25000)
  STOP
  DELAY(10000)
  CALL(CLOSE_TURNOUTS)
  // Change lights direction
  ...
  // Go to the home
  REV(27)
  ATTIMEOUT(R_WALL, 20000)
  STOP
  DELAY(10000)
  // Full stop
  CALL(SBB_CARGO_FULL_STOP)
